...
def main():
    ...
    global cascade
    global cascades
    parser = argparse.ArgumentParser(description="Run a varius face cascade classifier on a directory of images and output matched regions to new images")
    parser.add_argument("-i",action="store",dest="input_images",required=True)
    parser.add_argument("-o",action="store",dest="output")
    parser.add_argument("-c",action="store",dest="cascade_classifier")
    args = parser.parse_args()
    for filename in os.listdir(args.input_images+"*.jpg"):
        print filename
